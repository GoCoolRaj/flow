...
class CreateFabricUseCase
    extends BaseUseCase<CreateFabricRequest, CreateFabricResponse> {
  final _fabricRepository = GetIt.I.get<FabricGenRepository>();

  @override
  Future<CreateFabricResponse> execute({CreateFabricRequest? request}) {
    return _fabricRepository.createFabric(request!);
  }
}
